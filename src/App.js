    ...
    const loadRosters = async() => {
        ...
        boxscores.forEach(boxscore => {
            if (relevantTeams.includes(boxscore.homeTeamId)) {
                ...
                console.log('score:', boxscore.homeScore);
    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/scores" element={<Lineups loaded={loaded} teams={teams} matchups={matchups} refreshFunc={loadRosters} simulated={false}/>}/>
